            ...
            <div className={s.contentDiv}>
                <div className={s.content}>
                    ...
                    <div className={s.cardList} ref={ref} onClick={clickHandler}>
                        {loading ?  (arr.map(item => <GoodsPart1 key={item.articul} image={item.image}
                                                                 ...
                                                                 cost={item.cost}
                                                                 item={item}clickHandlerToWishList={clickHandlerToWishList}
